...
class WomenTanksObjects:
    ...
    catalogTanksXpath = [
        "//a[normalize-space()='Breathe-Easy Tank']",
        "//a[normalize-space()='Leah Yoga Top']",
        "//a[normalize-space()='Bella Tank']",
        "//a[normalize-space()=Lucia Cross-Fit Bra']"]
    ...
    def choiceForSizeAndColor(self):
        ...
        returns = common_funtions.choosing_action_of_items(self.driver, sizes, numbers, self.catalogTanksXpath,
